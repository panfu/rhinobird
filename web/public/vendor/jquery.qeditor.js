...
window.QEditor = {
  ...
  action: function(el, a, p) {
    ...
    if (a === "createLink") {
      ...
      if (typeof QEditor.onInsertImage === 'function') {
        QEditor.onInsertImage(function(url) {
          p = url;
  ...
  checkSectionState: function(editor) {
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      if (QEditor.state(a)) {
        results.push(link.addClass("qe-state-on"));
      } else {
        results.push(link.removeClass("qe-state-on"));
      }
    }
    return results;
  },
    ...
    return this.each(function() {
      ...
      editor.on("paste", function() {
        ...
        return setTimeout(function() {
          var attrName, els, i, len;
          els = txt.find("*");
          for (i = 0, len = QEDITOR_DISABLE_ATTRIBUTES_ON_PASTE.length; i < len; i++) {
            attrName = QEDITOR_DISABLE_ATTRIBUTES_ON_PASTE[i];
